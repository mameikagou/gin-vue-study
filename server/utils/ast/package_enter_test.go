	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/mameikagou/gin-vue-study/server/api/v1/example"`,
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/mameikagou/gin-vue-study/server/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/mameikagou/gin-vue-study/server/service/example"`,
